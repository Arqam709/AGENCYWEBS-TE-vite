...
const Footer = ({ theme }) => {
  return (
    <div className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-24 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
      {/* footer top */}
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        <div className="space-y-5 text-sm text-gray-700 dark:text-gray-400">
          ...
          <p className="max-w-md">
            from strategy to execution, we craft digital solutions that move your bussiness forward
          </p>
          ...
          <ul className="flex gap-8">
            ...
            <li className="hover:text-primary"><a href="#Reach-To-Us">Contact us</a></li>
          </ul>
        </div>
      ...
      <div className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
        <p>Copyright 2025 agency.io Nothing</p>

...
const ReachToUs = () => {
    ...
    formData.append("access_key", "0c56a010-012c-4af4-b718-ab605370d796");
  ...
  return (
    <div id='Contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      <Title title='Reach out to us' desc= 'From startegy to execution,we craft digital solutions that move your bussiness forward.'/>


      <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-2-2xl w-full'>

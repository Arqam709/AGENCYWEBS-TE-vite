...
import Turustedby from './components/Turustedby'
...
useEffect(() => {
  const handleMouseMove = (e) => {
    ...
    mouse.current.y = e.clientY; // <-- fixed typo
  };
  ...
  return () => {
    ...
    cancelAnimationFrame(rafId); // <-- prevent leak
  };
}, []);


  const [theme , setTheme] = useState(localStorage.getItem('theme') ? localStorage.getItem('theme') :'light') //last mode what we choose 
  return (
